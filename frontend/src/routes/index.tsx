  ...
  return (
    <Shell>
      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4 pb-4 border-b border-[#e4e0d5]">
        ...
        <div className="flex items-center gap-2 font-mono text-xs text-[#60646c] bg-white/70 backdrop-blur-md border border-white/80 px-3 py-1.5 rounded-md shadow-xs">
          <CheckCircle2 size={14} className="text-[#059669]" />
          <span>Analysis complete 09:42 UTC</span>
        </div>
      </div>

      {/* Top Row: 4 Stat Cards (Transparent Glass Boards) */}
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
        {/* Card 1: SCANNED BLOCKS */}
        <div className="rounded-2xl border border-white/70 bg-white/40 p-5 shadow-2xl backdrop-blur-2xl transition-all hover:bg-white/55 hover:scale-[1.01]">
          <div className="flex items-center justify-between">
            <p className="font-mono text-[10px] font-bold tracking-wider text-[#60646c] uppercase">SCANNED BLOCKS</p>
            <div className="grid size-8 place-items-center rounded-lg bg-[#059669]/15 text-[#059669] shadow-xs">
              <Layers size={16} />
            </div>
          </div>
          <p className="mt-3 font-mono text-3xl font-bold text-[#1c2024]">18,384</p>
          <p className="mt-1 font-mono text-[11px] text-[#60646c]">18,384 processed</p>
        </div>

        {/* Card 2: RECOVERED FILES */}
        <div className="rounded-2xl border border-white/70 bg-white/40 p-5 shadow-2xl backdrop-blur-2xl transition-all hover:bg-white/55 hover:scale-[1.01]">
          <div className="flex items-center justify-between">
            <p className="font-mono text-[10px] font-bold tracking-wider text-[#60646c] uppercase">RECOVERED FILES</p>
            <div className="grid size-8 place-items-center rounded-lg bg-[#2563eb]/15 text-[#2563eb] shadow-xs">
              <FileCheck2 size={16} />
            </div>
          </div>
          <p className="mt-3 font-mono text-3xl font-bold text-[#1c2024]">42</p>
          <p className="mt-1 font-mono text-[11px] text-[#60646c]">38 intact · 4 partial</p>
        </div>

        {/* Card 3: ENTROPY SCORE */}
        <div className="rounded-2xl border border-white/70 bg-white/40 p-5 shadow-2xl backdrop-blur-2xl transition-all hover:bg-white/55 hover:scale-[1.01]">
          <div className="flex items-center justify-between">
            <p className="font-mono text-[10px] font-bold tracking-wider text-[#60646c] uppercase">ENTROPY SCORE</p>
            <div className="grid size-8 place-items-center rounded-lg bg-[#0284c7]/15 text-[#0284c7] shadow-xs">
              <PieIcon size={16} />
            </div>
          </div>
          <p className="mt-3 font-mono text-3xl font-bold text-[#1c2024]">94%</p>
          <p className="mt-1 font-mono text-[11px] text-[#60646c]">high-entropy media</p>
        </div>

        {/* Card 4: ANOMALOUS PATTERNS */}
        <div className="rounded-2xl border border-white/70 bg-white/40 p-5 shadow-2xl backdrop-blur-2xl transition-all hover:bg-white/55 hover:scale-[1.01]">
          <div className="flex items-center justify-between">
            <p className="font-mono text-[10px] font-bold tracking-wider text-[#60646c] uppercase">ANOMALOUS PATTERNS</p>
            <div className="grid size-8 place-items-center rounded-lg bg-[#d97706]/15 text-[#d97706] shadow-xs">
              <AlertTriangle size={16} />
            </div>
          </div>
          <p className="mt-3 font-mono text-3xl font-bold text-[#1c2024]">3</p>
          <p className="mt-1 font-mono text-[11px] text-[#d97706] font-bold">require examiner review</p>
        </div>
      </div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-white/70 bg-white/40 p-6 shadow-2xl backdrop-blur-2xl">
          <div className="flex items-center justify-between border-b border-[#e4e0d5]/60 pb-4">
            ...
            <div className="flex items-center gap-1 rounded-xl border border-white/80 bg-white/30 p-1 font-mono text-[11px] backdrop-blur-md">
              <button
                onClick={() => setTab("composition")}
                className={`rounded-lg px-3 py-1 transition-all ${
                  tab === "composition" ? "bg-white/90 text-[#1c2024] font-bold shadow-md" : "text-[#60646c]"
                }`}
              >
                Composition
              </button>
              <button
                ...
                className={`rounded-lg px-3 py-1 transition-all ${
                  tab === "entropy" ? "bg-white/90 text-[#1c2024] font-bold shadow-md" : "text-[#60646c]"
                }`}
              >
                Entropy
              </button>
          ...
          <div className="mt-5 space-y-6">
            ...
            <div>
              ...
              <div className="flex h-4 overflow-hidden rounded-md bg-[#e4e0d5]/50 shadow-inner">
            ...
            {/* Primary Evidence Type Highlight Box (Transparent Glass) */}
            <div className="rounded-xl border border-white/80 bg-white/40 p-4.5 shadow-lg backdrop-blur-xl">
              <div className="flex items-start justify-between">
                <div>
                  <p className="font-mono text-[10px] font-bold tracking-wider text-[#2563eb] uppercase">PRIMARY EVIDENCE TYPE</p>
                  <p className="mt-1 font-mono text-3xl font-bold text-[#1c2024]">10×</p>
                  <p className="text-xs text-[#60646c] mt-0.5">Disk / corrupt output signatures recovered</p>
                </div>
                <div className="grid size-10 place-items-center rounded-xl bg-white/60 border border-white/80 text-[#2563eb] shadow-sm">
                  <BarChart3 size={20} />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex h-24 items-end gap-1 rounded-xl border border-white/70 bg-white/30 p-3 backdrop-blur-md">
        ...
        {/* Right Column (1 Col): Acquisition Record (Transparent Glass) */}
        <div className="rounded-2xl border border-white/70 bg-white/40 p-6 shadow-2xl backdrop-blur-2xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-[#e4e0d5]/60 pb-4">
              <h2 className="text-base font-bold text-[#1c2024]">Acquisition record</h2>
              <span className="inline-flex items-center gap-1 rounded-full border border-[#059669]/40 bg-[#059669]/10 px-3 py-0.5 font-mono text-[10px] font-bold text-[#059669]">
                ✓ VERIFIED
              </span>
            </div>

            <dl className="mt-4 divide-y divide-[#e4e0d5]/40 font-mono text-xs">
          ...
          {/* SHA-256 Fingerprint Transparent Box */}
          <div className="mt-6 rounded-xl border border-[#059669]/30 bg-[#059669]/10 p-4 backdrop-blur-md">
            <div className="flex items-center justify-between">
              <span className="font-mono text-[10px] font-bold text-[#059669] uppercase">SHA-256 FINGERPRINT</span>
              <button
                onClick={copyHash}
                className="flex items-center gap-1 font-mono text-[10px] text-[#059669] font-bold hover:underline"
              >
                {copied ? <Check size={12} /> : <Copy size={12} />}
                <span>{copied ? "Copied" : "Copy"}</span>
              </button>
            </div>
            <p className="mt-2 break-all font-mono text-[11px] font-bold text-[#059669]">
      ...
      {/* Bottom Row: Recent Activity Events Table (Transparent Glass) */}
      <div className="mt-6 rounded-2xl border border-white/70 bg-white/40 p-6 shadow-2xl backdrop-blur-2xl">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#e4e0d5]/60 pb-4">
          <div>
          ...
          <div className="flex items-center gap-2">
            <button className="rounded-lg border border-white/80 bg-white/50 px-3.5 py-1.5 font-mono text-xs font-semibold text-[#1c2024] hover:bg-white/80 shadow-sm transition-all">
              All events
            </button>
            <button className="rounded-lg border border-[#1c2024] bg-[#1c2024] px-3.5 py-1.5 font-mono text-xs font-semibold text-white hover:bg-black shadow-md flex items-center gap-1.5 transition-all">
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-left font-mono text-xs">
            <thead>
              <tr className="border-b border-[#e4e0d5]/60 text-[10px] font-bold uppercase tracking-wider text-[#60646c]">
            ...
            <tbody className="divide-y divide-[#e4e0d5]/40">
              <tr className="hover:bg-white/40 transition-colors">
                <td className="py-3.5 pr-4 font-bold text-[#1c2024]">09:42:18</td>
                <td className="py-3.5 px-4 text-[#60646c]">SCAN</td>
                <td className="py-3.5 px-4 font-semibold text-[#1c2024]">
                  18,384 blocks classified <span className="font-normal text-[#60646c]">- Full image pass completed - 94% mean entropy</span>
                </td>
                <td className="py-3.5 px-4 text-[#60646c]">Recon engine</td>
                <td className="py-3.5 pl-4 text-right">
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#059669]/15 px-3 py-0.5 text-[10px] font-bold text-[#059669]">
                    ✓ Complete
                  </span>
                </td>
              </tr>
              ...
              <tr className="hover:bg-white/40 transition-colors">
                <td className="py-3.5 pr-4 font-bold text-[#1c2024]">09:38:05</td>
                <td className="py-3.5 px-4 text-[#d97706]">FINDING</td>
                <td className="py-3.5 px-4 font-semibold text-[#1c2024]">
                ...
                <td className="py-3.5 px-4 text-[#60646c]">Pattern rule 7A</td>
                <td className="py-3.5 pl-4 text-right">
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#d97706]/15 px-3 py-0.5 text-[10px] font-bold text-[#d97706]">
                    🚩 Flagged
                  </span>
                </td>
              </tr>
              ...
              <tr className="hover:bg-white/40 transition-colors">
                <td className="py-3.5 pr-4 font-bold text-[#1c2024]">09:31:52</td>
                <td className="py-3.5 px-4 text-[#2563eb]">RECOVERY</td>
                <td className="py-3.5 px-4 font-semibold text-[#1c2024]">
                  Six partial files reconstructed <span className="font-normal text-[#60646c]">- JPEG: 3 · PDF: 2 · SQLITE: 1</span>
                </td>
                <td className="py-3.5 px-4 text-[#60646c]">Carving module</td>
                <td className="py-3.5 pl-4 text-right">
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#059669]/15 px-3 py-0.5 text-[10px] font-bold text-[#059669]">
                    ✓ Complete
                  </span>
              ...
              <tr className="hover:bg-white/40 transition-colors">
                <td className="py-3.5 pr-4 font-bold text-[#1c2024]">09:24:37</td>
                <td className="py-3.5 px-4 text-[#059669]">INTEGRITY</td>
                <td className="py-3.5 px-4 font-semibold text-[#1c2024]">
                  Source fingerprint revalidated <span className="font-normal text-[#60646c]">- SHA-256 matched acquisition manifest</span>
                </td>
                <td className="py-3.5 px-4 text-[#60646c]">ML Kernel</td>
                <td className="py-3.5 pl-4 text-right">
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#059669]/15 px-3 py-0.5 text-[10px] font-bold text-[#059669]">
                    ✓ Verified
                  </span>
              ...
              <tr className="hover:bg-white/40 transition-colors">
                <td className="py-3.5 pr-4 font-bold text-[#1c2024]">09:19:10</td>
                <td className="py-3.5 px-4 text-[#d97706]">FINDING</td>
                <td className="py-3.5 px-4 font-semibold text-[#1c2024]">
                  Timestamp discontinuity isolated <span className="font-normal text-[#60646c]">- NTFS $MFT entry 1042-1078 +14h skew</span>
                </td>
                <td className="py-3.5 px-4 text-[#60646c]">Timeline rule 3C</td>
                <td className="py-3.5 pl-4 text-right">
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#d97706]/15 px-3 py-0.5 text-[10px] font-bold text-[#d97706]">
                    🚩 Flagged
                  </span>
